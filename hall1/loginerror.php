...
if(isset($_POST['login'])){
  ...
  $query="SELECT user_no,username,password FROM user " ;
...
<body class="bg-light">
  ...
  <div class="modal-dialog shadow">
    <div class="modal-content">
    	<form action="loginerror.php" method="post" id="form">
      <div class="modal-header">

        <h5 class="modal-title d-flex align-items-center" id="staticBackdropLabel"><i class="bi bi-person-circle fs-3 me-2"></i>User Login</h5><br>

    <center> <div style="color:red;"><?php if(isset($_GET['error'])){echo $_GET['error'];}echo $error['login'];?></div> </center>
      </div>
