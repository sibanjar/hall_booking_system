          ...
          <img src="<?php echo $row['image'];?>" class="card-img-top" >
                ...
                <div class="features mb-4">
                 ...
                 <div class="d-flex justify-content-evenly mb-2">
                   ...
                   <button class="btn btn-sm text-white custom-bg shadow-none" onclick="fun()">Fullday Book</button>
                   <button class="btn btn-sm btn-outline-dark shadow-none" onclick="fun()">Partial Book</button>
                 </div>
