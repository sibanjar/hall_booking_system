            ...
            <div class="payment">
                <form>
                    ...
                    <div class="form-group" id="card-number-field">
                        ...
                        <input type="number" class="form-control" id="totalamount" value="<?=$_SESSION['hallprice1']?>" readonly>
                    </div>
                    ...
                    <div class="form-group" id="pay-now">
                        <button type="submit" class="btn btn-default" id="confirm-purchase" style="background-color:#8B0000">Confirm</button>
                    </div>
                </form>
            </div>
        </div>
